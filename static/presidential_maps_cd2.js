...
if (category == 2012) {
    winner = "2012_Obama_Vote";
    president = "Obama"
    loser = "2012_Romney_Vote";
    runner_up = "Romney"
    year = "2012_Obama_margin";
    new_category = 2012
 ...
 d3.json(query_url, function(data) {
    ...
    function style(feature) {
        ...
        //if (legend instanceof L.Control) { map.removeControl(legend); }
        //if (info instanceof L.Control) { map.removeControl(info); }
        //if (geojson instanceof L.geoJson) { map.removegeoJson(geojson); }
