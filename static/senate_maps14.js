...
var query_url = "http://127.0.0.1:5000/senate_info_api"
  ...
  d3.json(query_url, function(data) {
    ...
    (props ?
        ...
        '<b>' + props["Election_Data_Points"][`${special_election}`]["election_type"] + "<br>" +
        `</b> ${props["Election_Data_Points"][`${special_election}`]["winning_candidate"]} ${props["Election_Data_Points"][`${special_election}`]["winning_party"]}<br />`
        + props["Election_Data_Points"][`${special_election}`][`${winner}`] + '</b> <br />'
        + `</b> ${props["Election_Data_Points"][`${special_election}`]["losing_candidate"]} ${props["Election_Data_Points"][`${election}`]["losing_party"]}<br />` 
        + props["Election_Data_Points"][`${special_election}`][`${loser}`] + '</b> <br />'
        ...
        //props["Election_Data_Points"][`${special_election}`][`${winner}`].toFixed(2) + '%</b> <br />' 
        //+ `</b> ${props["Election_Data_Points"][`${special_election}`]["losing_candidate"]} (${props["Election_Data_Points"][`${special_election}`]["losing_party"]}):<br />` 
