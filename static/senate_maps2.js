...
var query_url = "http://127.0.0.1:5000/senate_api"
  ...
  d3.json(query_url, function(data) {
    ...
    this._div.innerHTML = '<h4>State Election Results</h4>' +  (props ?
        '<b>' + props.name + '</b>  2000 Bush Vote Share:<br />' + parseFloat(props.Past_Election_Results.Bush_Pct_00) + '%</b> <br />' + '</b> 2000 Gore Vote Share:<br />' + parseFloat(props.Past_Election_Results.Gore_Pct_00) + '%</b> <br />'
        : 'Hover over a state');
        };
        info.addTo(map);
    function getColor(d) {
